      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-20">
          {[
            ...
            <div
              key={idx}
              className="bg-orange-50 p-6 rounded-xl shadow hover:shadow-lg transition cursor-default text-center"
            >
              <Image
                src={src}
                alt={alt}
        ...
        <div
          className="bg-orange-600 text-white text-center rounded-xl py-14 px-6 max-w-4xl mx-auto shadow-lg hover:bg-orange-700 transition cursor-pointer"
          role="button"
          tabIndex={0}
          onClick={() => (window.location.href = "/volunteer")}
          onKeyDown={(e) => e.key === "Enter" && (window.location.href = "/volunteer")}
        >
